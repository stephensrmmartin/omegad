...
RcppExport SEXP _rcpp_module_boot_stan_fit4gpSpectralUni_mod();
...
RcppExport SEXP _rcpp_module_boot_stan_fit4relFactorGeneralGPBP_mod();
RcppExport SEXP _rcpp_module_boot_stan_fit4relFactorGeneralLin_mod();

static const R_CallMethodDef CallEntries[] = {
    {"_rcpp_module_boot_stan_fit4gpSpectralUni_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4gpSpectralUni_mod, 0},
    ...
    {"_rcpp_module_boot_stan_fit4relFactorGeneralGPBP_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4relFactorGeneralGPBP_mod, 0},
    {"_rcpp_module_boot_stan_fit4relFactorGeneralLin_mod", (DL_FUNC) &_rcpp_module_boot_stan_fit4relFactorGeneralLin_mod, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_omegad(DllInfo *dll) {
