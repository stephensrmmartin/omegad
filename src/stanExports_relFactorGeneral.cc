...
#include "stanExports_relFactorGeneral.h"

RCPP_MODULE(stan_fit4relFactorGeneral_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_relFactorGeneral")
